...
export const PERSONNEL_REGISTRY: Record<string, OperatorProfile> = {
  ...
  'OP-108': {
    ...
    badgeNumber: 'OP-108',
    fullName: 'Superintendent V. Nair',
    agency: 'Narcotics Control Bureau (NCB)',
    division: 'NCB Zonal Task Force · Mumbai',
    role: 'supervisor',
    status: 'ACTIVE',
  ...
  'OP-007': {
    ...
    badgeNumber: 'OP-007',
    fullName: 'Senior Scientific Officer Dr. A. Sen',
    agency: 'Central Forensic Science Laboratory (CFSL)',
    division: 'Digital Evidence & Chemical Audit Wing',
    role: 'auditor',
    status: 'ACTIVE',
